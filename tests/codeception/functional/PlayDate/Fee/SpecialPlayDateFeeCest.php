...
class SpecialPlayDateFeeCest extends AbstractCest
{
    ...
    public function createAsClown(FunctionalTester $I): void
    {
        $I->loginAsClown();
        $I->amOnPage('/play_dates/'.$this->playDateId);

        $I->see('Zusatztermin', 'h4');
        $I->dontSee('Honorar anlegen', Locator::contains('table tr', text: 'Honorar'));
    }
}
