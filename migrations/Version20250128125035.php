...
final class Version20250128125035 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE token (id INT AUTO_INCREMENT NOT NULL, token VARCHAR(255) NOT NULL, expires_at DATETIME NOT NULL, clown_id INT NOT NULL, INDEX IDX_5F37A13B87F943E2 (clown_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 ENGINE = INNODB');
