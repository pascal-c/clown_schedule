...
final class Version20230106161446 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO clown (name, gender, email, password, is_admin, is_active) VALUES ("Pascal", "male", "pascal.keimel@apwp.de", "'.password_hash('secret123', PASSWORD_DEFAULT).'", 1, 1)');
    }
