 ...
 */
final class Version20250208165933 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE token DROP FOREIGN KEY FK_5F37A13B87F943E2');
        $this->addSql('ALTER TABLE token ADD CONSTRAINT FK_5F37A13B87F943E2 FOREIGN KEY (clown_id) REFERENCES clown (id)');
    }
}
